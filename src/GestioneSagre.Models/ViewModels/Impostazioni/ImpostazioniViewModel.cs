...
public class ImpostazioniViewModel : BaseViewModel
{
    ...
    public static ImpostazioniViewModel FromEntity(ImpostazioniEntity impostazioni)
    {
        return new ImpostazioniViewModel
        {
            Id = impostazioni.Id,
