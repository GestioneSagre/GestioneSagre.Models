...
public class ProdottoDetailViewModel : BaseViewModel
{
    ...
    public static ProdottoDetailViewModel FromEntity(ProdottoEntity prodotto)
    {
        return new ProdottoDetailViewModel
        {
            Id = prodotto.Id,
